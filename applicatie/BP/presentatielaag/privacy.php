    ...
    <main>
        <div class="privacyTekst">
            <div class="container">
                ...
                <li>
                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to www.GelreAirport.nl.</p>
                </li>
                <li>
                ...
                <li>
                <p><strong>Website</strong> refers to www.GelreAirport.nl, accessible from <a href="http://127.0.0.1:3000/index.html" rel="external nofollow noopener" target="_blank">http://127.0.0.1:3000/index.html</a></p>
                </li>
                <li>
                ...
                <ul>
                <li>By email: office@GelreAirport.nl</li>
                </ul>
            </div>
        </div>
    </main>
